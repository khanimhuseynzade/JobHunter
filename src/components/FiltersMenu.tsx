  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm text-black"
      >
      ...
      {open && (
        <div className="absolute right-0 z-20 mt-1 min-w-[200px] rounded-xl border border-gray-200 bg-white p-2">
          <label className="flex cursor-pointer items-center gap-2 rounded-lg px-2 py-2 text-sm text-gray-600 hover:bg-gray-50">
            <input
              type="checkbox"
              checked={showSkipped}
